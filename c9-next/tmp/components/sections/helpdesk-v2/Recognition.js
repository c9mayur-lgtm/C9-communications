...
// src/components/sections/helpdesk-v2/Recognition.tsx
...
function Recognition() {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("section", { className: "w-full bg-white py-24 md:py-32", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "container mx-auto px-6 md:px-8 max-w-[800px] text-center", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      motion.h2,
      {
        ...
        className: "text-[32px] md:text-[44px] font-bold text-[#0c1024] mt-4 leading-[1.1] tracking-tight",
        style: { fontFamily: '"Proxima Nova", sans-serif' },
        children: [
          "Most businesses come to us after the ",
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[#5D00D6]", children: "same experience." })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "mt-12 flex flex-col gap-6 text-left", children: [
    ...
    ].map((text, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      motion.div,
      {
        ...
        className: "group bg-white border border-gray-100 rounded-[24px] px-8 py-7 flex items-center gap-8 text-left hover:border-[#5D00D6]/20 hover:shadow-xl hover:shadow-[#5D00D6]/5 transition-all duration-500",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-[56px] font-bold text-[#5D00D6]/10 shrink-0 leading-none h-[40px] flex items-center group-hover:text-[#5D00D6]/20 transition-colors", style: { fontFamily: '"Proxima Nova", sans-serif' }, children: "\u275D" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-[18px] md:text-[20px] font-medium text-slate-700 leading-relaxed", style: { fontFamily: '"Proxima Nova", sans-serif' }, children: text })
        ]
      },
      i
    )) }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      motion.p,
      {
        ...
        className: "text-[17px] md:text-[19px] text-slate-500 leading-relaxed mt-12 text-center font-normal",
        style: { fontFamily: '"Proxima Nova", sans-serif' },
        children: "These aren't edge cases \u2014 they're the most common reasons businesses switch to C9. Our helpdesk is built specifically to eliminate all three, delivering accountability instead of excuses."
      }
    )
  ] }) });
}
