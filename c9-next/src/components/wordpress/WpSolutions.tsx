...
import { UserPlus, Cloud, ShieldCheck, Monitor, Users, Smartphone, ArrowRight } from 'lucide-react';
    ...
    <section className="relative py-14 md:py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-8 max-w-[1240px] relative z-10">
        ...
        <div className="flex justify-center">
          <Button size="lg" className="shadow-2xl hover:gap-4 transition-all group border-none">
