...
export const WpPromoBanner = ({
  ...
  return (
    <section className="bg-[#0c1024] relative overflow-hidden">
      <div className="grid md:grid-cols-2 relative">
        
        {/* Removed decorative graphic overlap to keep image clean */}
        ...
        <div className="hidden md:block relative bg-gray-900 border-l border-white/10 z-0">
           <img 
             src={imageSrc} 
             alt="Promo Banner" 
