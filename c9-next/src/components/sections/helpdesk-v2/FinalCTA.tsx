      ...
      <div className="container mx-auto px-6 md:px-8 max-w-[1240px]">
        <div className="bg-[#0c1024] rounded-[48px] px-8 py-16 md:px-16 md:py-24 text-center relative overflow-hidden shadow-2xl shadow-purple-900/40 group transition-all duration-700 hover:scale-[1.01]">
          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            <span className="text-[#5D00D6] text-[14px] font-bold uppercase tracking-[0.4em] mb-8 block" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
              GET STARTED
            </span>
            
            <h2 className="text-[36px] md:text-[52px] lg:text-[64px] font-medium text-white mb-10 leading-[1.05] tracking-tight" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
              Ready to fix your <br /><span className="text-[#5D00D6]">helpdesk experience?</span>
            </h2>

            <p className="text-[18px] md:text-[18px] text-slate-300 mb-12 max-w-[600px] leading-relaxed font-normal" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center w-full sm:w-auto">
              <Link href="#proposal" className="w-full sm:w-auto" passHref>
                <Button size="lg" className="w-full sm:w-auto shadow-2xl hover:gap-6 group bg-[#5D00D6] hover:bg-[#4c00b0] text-white font-bold h-16 px-10 rounded-full border-none text-[17px]" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
              ...
              <Link href="/contact" className="w-full sm:w-auto" passHref>
                <Button variant="outline" size="lg" className="w-full sm:w-auto border-white/20 text-white font-bold h-16 px-10 rounded-full hover:bg-white hover:text-[#0c1024] transition-all bg-transparent text-[17px] border-2" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
                  Speak to an Expert
                </Button>
              </Link>
            </div>
