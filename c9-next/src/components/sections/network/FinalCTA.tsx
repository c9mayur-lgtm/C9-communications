...
export default function FinalCTA() {
  ...
  return (
    <section className="relative w-full bg-white py-20 px-6 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-8 w-full max-w-[1240px] text-center">
        <motion.div
        ...
        >
          ...
          <h2 className="font-['Proxima_Nova'] text-[42px] md:text-[58px] lg:text-[62px] font-bold text-[#1A1A2E] leading-[1.0] tracking-[-0.03em] max-w-[900px] mx-auto">
            Ready to <span className="text-[#5D00D6]">re-architect</span> your core network?
          </h2>
          
          <p className="font-['Proxima_Nova'] text-[19px] md:text-[21px] text-[#6B7280] mt-10 leading-[1.65] font-medium max-w-[700px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-5 justify-center mt-16 mb-16">
            <Button 
              ...
              className="bg-[#5D00D6] hover:bg-[#4c00b0] text-white font-['Proxima_Nova'] font-bold h-16 px-12 rounded-full text-[17px] transition-all shadow-[0_15px_40px_rgba(93,0,214,0.3)] group flex items-center gap-3 active:scale-95"
            >
            ...
            <a href="tel:1800000299" className="inline-block">
              <Button 
                variant="outline" 
                className="border-2 border-slate-100 text-[#1A1A2E] font-['Proxima_Nova'] font-bold h-16 px-12 rounded-full text-[17px] transition-all hover:bg-[#5D00D6] hover:text-white hover:border-[#5D00D6] bg-white flex items-center gap-3 active:scale-95 shadow-xl shadow-slate-900/5 group"
              >
