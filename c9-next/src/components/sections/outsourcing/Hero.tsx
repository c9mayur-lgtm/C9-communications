      ...
      <div className="container mx-auto max-w-[1240px] relative z-10">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-16 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              <Button className="bg-[#5D00D6] hover:bg-[#4c00b0] text-white px-10 h-14 rounded-none font-bold transition-all duration-300 shadow-2xl shadow-purple-900/30 group font-sans text-[16px]">
          ...
          {/* RIGHT COLUMN - ANIMATED INTERACTIVE VISUAL */}
          <motion.div 
          ...
          >
            <div className="w-full max-w-[540px] aspect-square bg-white border border-gray-100 rounded-[48px] p-10 shadow-[0_32px_80px_-20px_rgba(93,0,214,0.12)] relative overflow-hidden group">
              ...
              {/* Data Particles (Tiny moving dots) */}
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={`particle-${i}`}
                  animate={{ 
              ...
              >
                ...
                {[
                  ...
                  <motion.div 
                    ...
                    className="flex gap-2 text-[8px] font-bold font-sans"
                  >
              ...
              <motion.div 
                animate={{ 
                  boxShadow: ["0 0 0px 0px rgba(93,0,214,0)", "0 0 40px 10px rgba(93,0,214,0.15)", "0 0 0px 0px rgba(93,0,214,0)"]
                }}
              ...
              >
                <div className="w-40 h-40 bg-[#5D00D6] rounded-full flex flex-col items-center justify-center text-white relative overflow-hidden group">
                  ...
                  <motion.div 
                    ...
                    className="absolute left-0 right-0 h-px bg-white/40 blur-[1px] shadow-[0_0_10px_white]"
                  />
              ...
              {[
                ...
                >
                  <motion.div 
                    ...
                    className="flex flex-col items-center gap-2 group/node cursor-pointer"
                  >
              ...
              <motion.div
                ...
                className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-xl border border-gray-100 rounded-none p-5 shadow-xl flex items-center justify-between z-30"
              >
