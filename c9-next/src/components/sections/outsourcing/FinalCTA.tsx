    ...
    <section className="bg-white py-24 px-6 md:px-8 lg:px-12 overflow-hidden">
      <div className="container mx-auto max-w-[700px] text-center font-sans">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mt-10">
          <Button className="bg-[#5D00D6] hover:bg-[#4B00AD] text-white px-10 h-[56px] rounded-none font-bold transition-all text-[16px] font-sans">
            Get an IT Outsourcing Proposal <ArrowRight className="ml-2 w-5 h-5" />
          </Button>

          <a 
            href="tel:1800000299"
            className="inline-flex items-center justify-center border-2 border-[#E5E7EB] text-[#0c1024] hover:bg-slate-50 px-10 h-[56px] rounded-none font-bold transition-all text-[16px] font-sans"
          >
            Call 1800 000 299
          </a>
        </div>
