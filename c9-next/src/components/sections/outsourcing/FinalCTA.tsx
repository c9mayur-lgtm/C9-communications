  ...
  return (
    <section className="bg-white py-24 px-6 md:px-8 lg:px-12 overflow-hidden">
      <div className="container mx-auto max-w-[700px] text-center font-sans">
        ...
        <div className="text-[13px] text-slate-600 text-center mt-8  opacity-80 uppercase tracking-widest font-bold font-sans" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
