      ...
      <div className="container mx-auto px-6 md:px-8 max-w-[1240px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#12121A] border border-white/5 rounded-[24px] p-8 md:p-10 shadow-lg flex flex-col h-full hover:bg-[#16161F] transition-colors">
            <h3 className="text-[20px] md:text-[22px] text-white font-bold mb-3" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Essential 8 Implementation</h3>
            ...
            <div className="mt-auto flex items-center gap-4 bg-transparent border border-white/5 rounded-xl px-4 py-3">
              ...
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>C9 DEFENSE ASSESSMENT</span>
            </div>
          </div>

          <div className="bg-[#12121A] border border-white/5 rounded-[24px] p-8 md:p-10 shadow-lg flex flex-col h-full hover:bg-[#16161F] transition-colors">
            <h3 className="text-[20px] md:text-[22px] text-white font-bold mb-3" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Threat Monitoring</h3>
            <p className="text-[15px] md:text-[16px] text-gray-400 mb-8 leading-relaxed font-normal flex-grow" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
            ...
            <div className="mt-auto flex items-center gap-4 bg-transparent border border-white/5 rounded-xl px-4 py-3">
              ...
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>C9 CONTINUOUS SECURITY</span>
            </div>
          </div>

          <div className="bg-[#12121A] border border-white/5 rounded-[24px] p-8 md:p-10 shadow-lg flex flex-col h-full hover:bg-[#16161F] transition-colors">
            <h3 className="text-[20px] md:text-[22px] text-white font-bold mb-3" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Recovery Assurance</h3>
            <p className="text-[15px] md:text-[16px] text-gray-400 mb-8 leading-relaxed font-normal flex-grow" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
            ...
            <div className="mt-auto flex items-center gap-4 bg-transparent border border-white/5 rounded-xl px-4 py-3">
              ...
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>C9 DATA PROTECTION</span>
            </div>
          </div>
        </div>
