        ...
        <div className="grid xl:grid-cols-[1.1fr_0.9fr] gap-4 xl:gap-6 items-center relative z-10 w-full">
          <div className="py-4 pr-0 xl:pr-6">
            ...
            <h1 className="text-[38px] sm:text-[48px] md:text-[52px] lg:text-[62px] font-bold tracking-tight mb-6 text-[#0c1024] leading-[1.08]" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
              Managed IT and Telco built for Australian <span className="text-[#5D00D6]">real estate agencies.</span>
            </h1>
            <p className="text-[17px] md:text-[18px] lg:text-[20px] text-slate-600 mb-8 max-w-[560px] leading-relaxed font-normal" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
              From the office to the open home — C9 manages your IT and connectivity so your agents stay connected, your client data stays protected, and your team focuses on transactions, not technology.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mt-8">
              <Link href="/contact" passHref>
                <Button size="lg" className="w-full sm:w-auto shadow-2xl hover:gap-4 group bg-[#5D00D6] hover:bg-[#4c00b0] text-white font-bold h-14 px-8 rounded-full border-none" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
                  Speak to Our Real Estate IT Specialist <ArrowRight className="transition-transform group-hover:translate-x-1 ml-2" />
                </Button>
              </Link>
            ...
            <div className="flex items-center gap-5 md:gap-8 mt-10 md:mt-12 flex-wrap pb-4">
              {['Client data privacy compliant', 'Mobile and field agent support', 'Multi-office network management'].map((t, i) => (
          ...
          <div className="hidden xl:block w-full h-[400px] lg:h-[500px] relative rounded-none overflow-hidden shadow-2xl">
            <img
              src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=2850"
            ...
            <div className="absolute bottom-10 left-10 p-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl max-w-sm">
              <div className="text-white text-[12px] font-bold uppercase tracking-wider mb-2" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Mobile-First Support</div>
              <div className="text-white text-[24px] font-bold leading-tight" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Seamless Connectivity from Office to Open Home</div>
            </div>
          </div>
        </div>
      </div>
