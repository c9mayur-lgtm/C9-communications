...
export default function SingleBillSection() {
  return (
    <section className="bg-white py-16 md:py-20 overflow-hidden" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
      <div className="container mx-auto px-6 md:px-8 max-w-[1240px]">
        {/* HEADER */}
        <div className="flex flex-col mb-10 gap-4">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 bg-[#5D00D6]/5 rounded-none border border-[#5D00D6]/10 w-fit">
             <div className="w-1.5 h-1.5 rounded-full bg-[#5D00D6] animate-pulse" />
             <span className="text-[#5D00D6] text-[11px] font-black uppercase tracking-[0.3em]">C9 SINGLE BILL</span>
          </div>
          <h2 className="text-[36px] md:text-[52px] font-bold tracking-tight text-[#1A1A2E] leading-tight mb-4">
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-16 lg:gap-24 items-start">
          ...
          <div className="flex flex-col gap-10">
            <div className="space-y-6 text-slate-600 text-[18px] md:text-[20px] leading-relaxed font-normal max-w-xl">
              <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="text-[14px] font-bold text-[#1A1A2E] tracking-tight whitespace-nowrap">
                    {feature}
                  </span>
                </div>
              ))}
            ...
            <div className="pt-4">
               <Button 
                ...
                className="bg-[#5D00D6] text-white hover:bg-[#4c00b0] font-bold h-[56px] px-10 rounded-full transition-all text-[15px] shadow-xl shadow-[#5D00D6]/20 flex items-center gap-2 transform hover:-translate-y-0.5"
              >
          ...
          <div className="flex flex-col gap-6">
             <p className="text-[11px] font-black text-[#5D00D6] uppercase tracking-[0.4em] mb-4">Related Services</p>
                ...
                {SERVICES.map((service, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <h4 className="text-[18px] font-bold text-[#1A1A2E] leading-tight group-hover:text-[#5D00D6] transition-colors">{service.title}</h4>
                      <p className="text-slate-500 text-[14px] leading-relaxed mb-1">{service.body}</p>
                      <span className="text-[12px] font-black uppercase text-[#5D00D6] tracking-widest">{service.link}</span>
                    </div>
                  </motion.a>
                ))}
             </div>
