      ...
      <div className="container mx-auto max-w-[1240px] relative z-10 font-sans">
        <div className="grid lg:grid-cols-[1fr_1fr] gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start max-w-[580px]">
            ...
            >
              <Button className="flex-1 sm:flex-none bg-[#5D00D6] hover:bg-[#4c00b0] text-white px-8 h-12 rounded-full font-bold transition-all duration-300 shadow-xl shadow-purple-900/30 group font-sans text-[15px]">
                Book Session <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </Button>
              <Button variant="outline" onClick={scrollToEngagement} className="flex-1 sm:flex-none text-[#0c1024] bg-white hover:bg-slate-50 border-[#5D00D6]/20 px-8 h-12 rounded-full font-bold transition-all font-sans text-[15px]">
                View Model
              </Button>
            </motion.div>
          </div>
