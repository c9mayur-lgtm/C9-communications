        ...
        <div className="grid lg:grid-cols-[55%_45%] gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start max-w-[640px]">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10 w-full sm:w-auto">
              <Button className="flex-1 sm:flex-none bg-[#5D00D6] hover:bg-[#4d00b3] text-white px-8 h-14 rounded-full font-bold transition-all text-[15px] shadow-lg shadow-purple-900/20">
