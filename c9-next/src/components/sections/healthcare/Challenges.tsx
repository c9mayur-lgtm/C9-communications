        ...
        <div className="flex flex-col lg:flex-row lg:flex-wrap divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
          {[
            ...
            },
            {
              ...
              link: { href: '/c9-defense', text: 'C9 DEFENSE — Read more' }
            },
            {
            ...
            <div key={i} className={`flex flex-col items-start w-full lg:w-1/4 ${i === 0 ? 'pb-8 lg:pb-0 lg:pr-8' :
              ...
              {f.link && (
                <div className="mt-auto pt-2 border-t-[1px] border-gray-100 w-full">
                  <Link href={f.link.href} className="inline-flex items-center gap-1.5 text-[11px] font-bold text-[#5D00D6] uppercase tracking-[0.1em] hover:opacity-80 transition-opacity mt-4" style={fontStyle}>
                    <Shield size={12} fill="currentColor" /> {f.link.text}
                  </Link>
                </div>
              )}
            </div>
