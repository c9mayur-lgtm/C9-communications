        ...
        <div className="grid xl:grid-cols-[1.1fr_0.9fr] gap-4 xl:gap-6 items-center relative z-10 w-full">
          <div className="py-4 pr-0 xl:pr-6">
            ...
            <h1 className="text-[36px] sm:text-[42px] md:text-[52px] lg:text-[56px] font-bold tracking-tight mb-6 text-[#0c1024] leading-[1.1]" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
              Managed IT and Telco built for Australian healthcare providers.
            </h1>
          ...
          <div className="hidden xl:block w-full h-[400px] lg:h-[500px] relative rounded-none overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-10 left-10 p-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl max-w-sm">
                <div className="text-white text-[12px] font-bold uppercase tracking-wider mb-2" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Infrastructure Design</div>
                <div className="text-white text-[24px] font-bold leading-tight" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>Fully HIPAA-aligned & Secure Environments</div>
            </div>
          </div>
        </div>
      </div>
