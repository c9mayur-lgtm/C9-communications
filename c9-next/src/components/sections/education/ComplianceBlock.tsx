      ...
      <div className="container mx-auto px-6 md:px-8 max-w-[1240px] relative z-10">
        <div className="max-w-[760px] mx-auto text-center flex flex-col items-center mb-12">
          ...
          <h2 className="text-[32px] md:text-[40px] font-bold text-white leading-[1.1] tracking-tight mb-6" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
            Student data protection and compliance aren't optional. We make them manageable.
          </h2>
          <p className="text-gray-400 text-[17px] md:text-[18px] leading-relaxed font-normal" style={{ fontFamily: '"Proxima Nova", sans-serif' }}>
            Australian education providers are bound by the Privacy Act, state-based student data obligations, and increasingly, government reporting requirements around cybersecurity maturity. C9 Defense implements the ACSC Essential 8 framework — giving your institution documented compliance, continuous monitoring, and auditable security controls.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "We map your institution's IT environment against the ACSC baseline, identify gaps, and deliver a phased remediation roadmap tailored to an education context.",
              items: ["Essential 8 implementation and gap assessment", "Student data access controls and audit logging", "Compliance reporting for government obligations"],
              badge: "C9 DEFENSE ASSESSMENT"
            },
            {
              title: "Threat Monitoring",
              desc: "Continuous security monitoring across your campus environment — detecting ransomware, phishing, and unauthorized access attempts before they impact your institution.",
              items: ["24/7 SOC monitoring", "Continuous threat monitoring and response", "Privileged access governance"],
              badge: "C9 CONTINUOUS SECURITY"
            },
            {
              title: "Recovery Assurance",
              desc: "Immutable backups and tested disaster recovery to protect student records, learning platforms, and administration data — with documented recovery targets.",
