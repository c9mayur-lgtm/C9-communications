            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div style={{
                  ...
                  <h3 style={{ fontFamily: "'Clash Display', sans-serif", fontSize: '24px', fontWeight: 800, color: '#fff', marginBottom: '16px' }}>{v.title}</h3>
                  <p style={{ fontSize: '15px', lineHeight: 1.6, color: 'rgba(248,245,255,0.5)' }}>{v.desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '40px', textAlign: 'center' }}>
            {[
              ...
              <FadeIn key={i} delay={i * 0.05}>
                <div style={{ fontFamily: "'Clash Display', sans-serif", fontSize: '40px', fontWeight: 900, color: '#fff', marginBottom: '8px' }}>{s.val}</div>
                <div style={{ fontSize: '12px', fontWeight: 700, color: '#A855F7', textTransform: 'uppercase', letterSpacing: '0.1em' }}>{s.label}</div>
              </FadeIn>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '120px 0' }}>
        <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            <FadeIn>
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(167,139,250,0.2)', borderRadius: '24px', padding: '48px', position: 'relative' }}>
                  ...
                  <h3 style={{ fontFamily: "'Clash Display', sans-serif", fontSize: '32px', fontWeight: 900, color: '#fff', marginBottom: '24px' }}>Born in Sydney</h3>
                  <p style={{ fontSize: '16px', lineHeight: 1.8, color: 'rgba(248,245,255,0.6)', marginBottom: '24px' }}>
                  ...
                  <p style={{ fontSize: '16px', lineHeight: 1.8, color: 'rgba(248,245,255,0.6)' }}>
            ...
            <div>
              <FadeIn delay={0.2}>
                <h2 style={{ fontFamily: "'Clash Display', sans-serif", fontSize: '40px', fontWeight: 900, color: '#fff', marginBottom: '32px' }}>A team of Australian experts.</h2>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                  {[
                    ...
                    <div key={i} style={{ display: 'flex', gap: '20px' }}>
                      ...
                      <div>
                        <h4 style={{ color: '#fff', fontSize: '18px', fontWeight: 700, marginBottom: '6px' }}>{f.title}</h4>
                        <p style={{ color: 'rgba(248,245,255,0.5)', fontSize: '14px', lineHeight: 1.6 }}>{f.text}</p>
                      </div>
                    </div>
                  ))}
                </div>
