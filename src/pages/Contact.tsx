          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.2fr) minmax(0, 0.8fr)', gap: '64px' }}>
            ...
            <FadeIn delay={0.3}>
              <div style={{
                ...
                <h3 style={{ fontWeight: 800, color: '#fff', marginBottom: '32px' }}>Send us a message</h3>
                
                <form onSubmit={e => e.preventDefault()} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                  <div style={{ gridColumn: 'span 1' }}>
                    <label style={{ display: 'block', fontWeight: 600, color: 'rgba(248,245,255,0.5)', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Full Name</label>
                    <input type="text" placeholder="John Doe" style={{ width: '100%', background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.2)', borderRadius: '12px', padding: '14px 18px', color: '#fff', }} />
                  </div>
                  <div style={{ gridColumn: 'span 1' }}>
                    <label style={{ display: 'block', fontWeight: 600, color: 'rgba(248,245,255,0.5)', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Work Email</label>
                    <input type="email" placeholder="john@company.com" style={{ width: '100%', background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.2)', borderRadius: '12px', padding: '14px 18px', color: '#fff', }} />
                  </div>
                  <div style={{ gridColumn: 'span 2' }}>
                    <label style={{ display: 'block', fontWeight: 600, color: 'rgba(248,245,255,0.5)', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Company Name</label>
                    <input type="text" placeholder="Acme Corp" style={{ width: '100%', background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.2)', borderRadius: '12px', padding: '14px 18px', color: '#fff', }} />
                  </div>
                  <div style={{ gridColumn: 'span 2' }}>
                    <label style={{ display: 'block', fontWeight: 600, color: 'rgba(248,245,255,0.5)', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Message</label>
                    <textarea placeholder="How can we help your business?" rows={5} style={{ width: '100%', background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.2)', borderRadius: '12px', padding: '14px 18px', color: '#fff', resize: 'none' }} />
                  </div>
                  <div style={{ gridColumn: 'span 2', marginTop: '8px' }}>
                    <button style={{
                      width: '100%', padding: '16px', borderRadius: '12px', background: 'linear-gradient(135deg, #7C3AED, #6B21A8)',
                      color: '#fff', fontWeight: 700, border: '1px solid rgba(167,139,250,0.3)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer'
                    }}>
                      Send Inquiry <Send size={16} />
                    </button>
                    <p style={{ textAlign: 'center', color: 'rgba(248,245,255,0.35)', marginTop: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              <FadeIn delay={0.4}>
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(167,139,250,0.1)', borderRadius: '20px', padding: '32px' }}>
                  ...
                  <h4 style={{ fontWeight: 700, color: '#fff', marginBottom: '8px' }}>Call Support</h4>
                  <p style={{ color: 'rgba(248,245,255,0.5)', marginBottom: '16px' }}>Available 24/7 for critical faults.</p>
              ...
              <FadeIn delay={0.5}>
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(167,139,250,0.1)', borderRadius: '20px', padding: '32px' }}>
                  ...
                  <h4 style={{ fontWeight: 700, color: '#fff', marginBottom: '8px' }}>Email Us</h4>
                  <p style={{ color: 'rgba(248,245,255,0.5)', marginBottom: '16px' }}>For general sales and quotes.</p>
              ...
              <FadeIn delay={0.6}>
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(167,139,250,0.1)', borderRadius: '20px', padding: '32px' }}>
                  ...
                  <h4 style={{ fontWeight: 700, color: '#fff', marginBottom: '8px' }}>Headquarters</h4>
                  <p style={{ color: 'rgba(248,245,255,0.5)', lineHeight: 1.5 }}>
      ...
      <section style={{ padding: '80px 0', borderTop: '1px solid rgba(167,139,250,0.1)', background: 'rgba(255,255,255,0.01)' }}>
        <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 style={{ fontWeight: 800, color: '#fff' }}>Quick Support</h2>
          </div>
             ...
             {[
               ...
               <FadeIn key={i} delay={i * 0.1}>
                 <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(167,139,250,0.1)' }}>
                   ...
                   <h5 style={{ color: '#fff', fontWeight: 700, marginBottom: '8px' }}>{item.title}</h5>
                   <p style={{ color: 'rgba(248,245,255,0.4)', lineHeight: 1.5 }}>{item.text}</p>
                 </div>
               </FadeIn>
             ))}
          </div>
