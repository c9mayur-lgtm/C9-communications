...
const PathOption = ({ 
  ...
  <button
    ...
    className={cn(
      "flex flex-col items-center justify-center p-3 rounded-lg border transition-all duration-300 gap-2 flex-1",
      isSelected 
...
export const ConsultationFormCore = ({ formTitle, ctaText }: ConsultationFormCoreProps) => {
  ...
  if (isSuccess) {
    return (
      <div className="bg-white rounded-2xl p-8 md:p-10 w-full max-w-[600px] mx-auto lg:ml-auto flex flex-col items-center justify-center min-h-[400px] animate-in fade-in duration-500">
        <div className="w-16 h-16 bg-[#5D00D6] rounded-xl flex items-center justify-center text-white mb-6">
          <Zap size={32} />
        </div>
  ...
  return (
    <div className="bg-white rounded-2xl p-8 md:p-10 w-full max-w-[600px] mx-auto lg:ml-auto">
