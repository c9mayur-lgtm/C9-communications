      ...
      >
        <div className="flex flex-col md:flex-row min-h-[500px] md:min-h-[600px]">
          ...
          <div className={cn("relative w-full md:w-[45%] p-8 md:p-12 text-white flex flex-col justify-between overflow-hidden min-h-[250px] md:min-h-full", config.leftBg)}>
            {/* Logo — Using official SVG */}
            <div className="relative z-10">
              <div className="mb-8 md:mb-12">
                <Image 
                  src="/images/c9_logo_light.svg" 
              ...
              <div className="space-y-3 md:space-y-4">
                <span className="text-[9px] md:text-[10px] font-semibold uppercase tracking-[0.2em] opacity-70">Expert Framework</span>
                <h2 className="text-2xl md:text-3xl font-bold leading-tight italic uppercase">
                  {config.title}
                </h2>
                <p className="text-white/60 text-xs md:text-sm font-normal max-w-[240px] leading-relaxed">
                  {config.subtitle}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 md:mt-8 relative z-10 hidden md:block">
               <div className="bg-white text-[#5D00D6] px-5 py-2.5 rounded-full inline-flex items-center gap-2 font-bold text-[10px] uppercase tracking-wider shadow-xl">
                  {config.ctaLabel}
               </div>
            </div>
            ...
            <div className="absolute -bottom-6 -right-6 md:-bottom-10 md:-right-10 w-[70%] md:w-[85%] aspect-[3/4] z-0 opacity-90 rotate-[-8deg] drop-shadow-2xl">
               <Image 
                 src={config.image || '/images/promo_business_audit.png'}
                 alt="Report Mockup"
                 fill
          ...
          <div className="relative w-full md:w-[55%] bg-white p-8 md:p-12 flex flex-col justify-center">
            {/* Single Close Button */}
            <DialogClose className="absolute top-6 right-6 p-2.5 rounded-full hover:bg-slate-50 transition-colors text-slate-300 hover:text-slate-500 z-50 border border-slate-100">
              <X size={20} />
              <span className="sr-only">Close</span>
            </DialogClose>

            <div className="max-w-[400px] mx-auto w-full relative z-10">
              <h3 className="text-2xl md:text-3xl font-bold text-[#0c1024] mb-3 leading-tight">
                {config.formTitle}
              </h3>
              <p className="text-slate-500 text-sm md:text-base mb-8 md:mb-10 leading-relaxed font-normal">
                {config.formSubtitle}
              </p>
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="first-name" className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">First Name <span className="text-red-500">*</span></Label>
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="last-name" className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Last Name <span className="text-red-500">*</span></Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="job-title" className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Job Title <span className="text-red-500">*</span></Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="email" className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Email <span className="text-red-500">*</span></Label>
                ...
                <div className="pt-4">
                  <C9Button 
                    showArrow={true}
                    className="w-full h-14 bg-[#5D00D6] hover:bg-[#4d00b3] text-white rounded-full text-base font-bold shadow-xl shadow-purple-900/20 flex items-center justify-center gap-2 group"
                  >
                    {config.ctaLabel}
                  </C9Button>
                </div>
