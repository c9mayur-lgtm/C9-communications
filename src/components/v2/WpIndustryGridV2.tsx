...
const INDUSTRIES = [
  ...
  },
  {
    ...
    desc: 'Managed devices, campus networking, and M365 for staff and students — keeping classrooms connected and IT teams sane.',
    metrics: [
  ...
  },
  {
    ...
    desc: 'Fast internet, mobile plans, and cloud phone systems for agents who are always on the move — your IT should keep up.',
    metrics: [
