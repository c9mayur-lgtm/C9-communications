  ...
  return (
    <section className="py-16 lg:py-20 bg-slate-50 border-y border-slate-100 overflow-hidden">
      <div className="container mx-auto px-6 md:px-8 max-w-[1240px]">
        <div className="bg-white rounded-[48px] p-8 lg:p-20 shadow-2xl shadow-purple-900/5 border border-slate-100 relative">
          {/* Decorative Gradient */}
          <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-[#5D00D6]/5 to-transparent rounded-r-[48px] pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-[60%_40%] gap-16 items-center">
            ...
            <FadeIn delay={0.2}>
              <div className="relative">
                ...
                <div className="absolute inset-0 -z-10 bg-slate-200 rounded-3xl -rotate-3 translate-x-4" />
              </div>
            </FadeIn>
          </div>
        </div>
