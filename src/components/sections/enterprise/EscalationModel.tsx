  ...
  return (
    <section className="py-16 lg:py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-6 md:px-8 max-w-[1240px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            {steps.map((step, i) => (
              <FadeIn key={i} delay={i * 0.1}>
                <div className="bg-white rounded-none p-10 transition-all duration-500 h-full group">
        ...
        <FadeIn delay={0.4}>
          <div className="mt-20 lg:mt-32 p-10 lg:p-14 bg-[#0c1024] rounded-none text-white relative overflow-hidden group">
