          ...
          <div className="grid sm:grid-cols-2 gap-6 relative">
            ...
            {tiers.map((tier, i) => (
              <FadeIn key={i} delay={i * 0.1}>
                <div className="bg-white rounded-lg p-8 transition-all duration-500 h-full">
                  <div className={`w-14 h-14 rounded-2xl ${tier.bgColor} ${tier.color} flex items-center justify-center mb-8 group-hover:scale-110 duration-500`}>
