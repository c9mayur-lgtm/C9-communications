...
import { ArrowRight, Repeat, HardHat, Wifi, Network, Layers, LayoutGrid } from 'lucide-react';
      ...
      <div className="container mx-auto px-8 max-w-[1240px] relative z-10">
        ...
        <div className="flex justify-center mt-12">
          <button 
            ...
            className="inline-flex items-center justify-center gap-2 shadow-2xl hover:gap-4 transition-all group bg-[#5D00D6] text-white rounded-full h-14 px-10 text-base font-bold shadow-lg shadow-[#5D00D6]/20"
          >
