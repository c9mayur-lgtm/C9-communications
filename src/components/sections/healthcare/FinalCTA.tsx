      ...
      <div className="container mx-auto max-w-[800px] text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="tel:1800000299" passHref>
            <Button variant="outline" size="lg" className="w-full sm:w-auto border border-white/20 text-white bg-transparent hover:bg-white/10 hover:text-white rounded-full px-8 h-14 font-bold text-[14px]" >
              Call 1800 000 299
            </Button>
          </Link>
        </div>
