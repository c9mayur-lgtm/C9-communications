        ...
        <div className="grid grid-cols-1 md:grid-cols-[40%_60%] gap-3 h-auto md:h-[380px]">
          ...
          <div className="bg-[#343331] rounded-xl md:rounded-2xl p-8 md:p-10 flex flex-col justify-center shadow-md relative">
            <p className="text-[#FDFDFD] text-[20px] md:text-[24px] lg:text-[28px] leading-[1.35] font-bold mb-8 tracking-tight" >
              "With store uptime being critical to our revenue, C9's managed connectivity and failover solutions have been a game-changer. We no longer worry about local network outages impacting our ability to trade."
            </p>
            <div className="mt-auto">
              <div className="flex items-center gap-2.5 mb-5 opacity-90">
                ...
                <span className="text-white text-[16px] font-bold tracking-tight" >RETAIL BUSINESS CLIENT</span>
              </div>
              <div className="text-white/80 text-[14px] md:text-[14px] font-medium tracking-wide" >
                Operations Director — Australian Retail Group
              </div>
            </div>
          </div>
        </div>
        <div className="flex justify-center mt-12">
          <Link href="/case-studies/multi-site-retail-stabilisation" className="inline-flex items-center gap-2 text-[#5D00D6] text-[14px] font-bold uppercase tracking-wider hover:opacity-70 transition-opacity" >
            Read full case study <span className="text-[16px]">→</span>
          </Link>
        </div>
      </div>
    </section>
