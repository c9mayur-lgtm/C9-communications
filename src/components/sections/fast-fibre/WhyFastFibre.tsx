...
import { Zap, Settings, Cloud, Globe, Shield, Server } from 'lucide-react';
    ...
    <section className="relative py-14 md:py-16 overflow-hidden" >
      ...
      <div className="container mx-auto px-8 max-w-[1240px] relative z-10">
        <div className="flex flex-col mb-16 gap-4">
          <span className="c9-eyebrow !text-white opacity-80 mb-4 block">WHY FAST FIBRE</span>
          <h2 className="c9-section-heading !text-white">
            When your business demands<br />connectivity — your way.
          </h2>
          <p className="c9-body !text-white/85 max-w-[720px] !text-[18px] md:!text-[20px] font-medium leading-relaxed mt-2">
