...
export const metadata: Metadata = {
  ...
  description: "Enterprise-grade managed IT, network, and security services for multi-site organisations across Australia, backed by continuous operations, SLA-driven support, and proven large-scale deployments.",
  ...
  openGraph: {
    ...
    description: "Enterprise-grade managed IT, network, and security services for multi-site organisations across Australia, backed by continuous operations and SLA-driven support.",
