...
import { CheckCircle, ShieldCheck, Zap, Monitor, Lock, Activity, Users, Network, Wifi, Globe, Share2, Server, AlertTriangle, RefreshCw, BarChart3, Radio, LayoutGrid, Layers, Database } from 'lucide-react';
import { WpClientTicker } from '@/components/wordpress/WpClientTicker';
import { WpConsultationForm } from '@/components/wordpress/WpConsultationForm';
import { WpDefenseBanner } from "@/components/wordpress/WpDefenseBanner";
import { RouterControlVisual } from './components/RouterControlVisual';
               ...
               <div className="grid sm:grid-cols-2 gap-6">
                  {[
                     ...
                     <div key={i} className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <h4 className="font-bold text-slate-900 mb-2 text-[15px]">{item.title}</h4>
      ...
      <div className={C}>
         <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <FadeIn direction="right" className="bg-[#0c1024] rounded-[48px] p-8 lg:p-12 text-white relative overflow-hidden shadow-2xl">
               <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#5D00D6] opacity-10 rounded-full blur-[100px]" />
               <div className="relative z-10">
                  <h3 className="text-2xl font-bold mb-8 !text-white">Existing Integration</h3>
            ...
            <FadeIn direction="right">
               <div className="p-10 rounded-[48px] bg-white/5 border border-white/10 backdrop-blur-sm">
                  ...
                  <div className="flex items-center gap-4">
                     ...
                     <div>
                        <div className="font-bold text-white">Head of Infrastructure</div>
...
/* ─────────────────────────────────────────────────────────
   PAGE EXPORT
   ───────────────────────────────────────────────────────── */
export default function RoutersSwitchesPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <WpDefenseBanner 
        title={<>Network-Level <span className="text-[#a56eff]">Protection.</span></>}
