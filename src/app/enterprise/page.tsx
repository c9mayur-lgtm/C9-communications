          ...
          <FadeIn direction="right">
             ...
             <div className="space-y-4">
                {[
                  ...
                  { icon: <Server size={18} aria-hidden="true" />, title: 'Legacy Infrastructure Governance', desc: 'Bringing brownfield environments into a modern governance model without service disruption.' }
                ].map((item, i) => (
