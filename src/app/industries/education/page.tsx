...
import { CheckCircle, Wifi, Network, Shield, HeadphonesIcon, AlertTriangle, GraduationCap, Users, Clock, BookOpen } from 'lucide-react';
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0c1024]/90 via-[#0c1024]/20 to-transparent flex items-end p-10">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 w-full">
                <div className="flex items-center gap-4 text-white">
                  ...
                  <div>
                    <div className="font-bold text-[14px]">1,200+ Concurrent Devices</div>
                    <div className="text-white/70 text-[14px]">Zero congestion. Zero dropout.</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="container mx-auto px-6 md:px-8 max-w-[1240px]">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <FadeIn>
          ...
          >
            Meet the team backing your staff 
          </a>
        </FadeIn>
