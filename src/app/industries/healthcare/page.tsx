...
import { CheckCircle, Wifi, Phone, Network, Shield, HeadphonesIcon, AlertTriangle, Activity, Lock, Clock, FileText } from 'lucide-react';
    ...
    <div className="container mx-auto px-6 md:px-8 max-w-[1240px]">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <FadeIn>
          ...
          >
            See how our support desk operates 
          </a>
        </FadeIn>
