...
export const ENTERPRISE_CAPABILITIES_DATA: OfferingData[] = [
  {
    ...
    problemContext: "Reliance on a single internet provider creates a critical single point of failure. When your ISP goes down, your entire business stops. For enterprises managing multiple locations, this risk is multiplied across your telco & IT.",
    solutionTitle: "Carrier-Grade Internet Telco & IT",
    solutionDescription: "Multi-carrier internet redundancy with automatic failover, 99.99% uptime SLA, and proactive telco & IT monitoring. Designed for enterprises that cannot tolerate downtime.",
    features: [
    ...
    caseStudyQuote: "We manage 50+ locations across Australia. Telco & IT downtime was impacting operations. C9 implemented carrier-grade redundancy. Result: 99.99% uptime maintained. Zero unplanned outages in 24 months.",
    caseStudyAuthor: "Telco & IT Director, Multi-Location Enterprise (50+ locations)",
  ...
  },
  {
    ...
    solutionTitle: "Enterprise-Grade Unified Network Telco & IT",
  ...
  },
  {
    ...
    problemContext: "Unmanaged printing telco & IT across multiple locations creates security vulnerabilities and cost overruns. Without centralized management, you cannot ensure data protection or control costs.",
    solutionTitle: "Enterprise Print Telco & IT Management",
    solutionDescription: "Centrally managed print telco & IT with security controls, compliance audit trails, detailed usage analytics, and cost optimization.",
    features: [
    ...
    caseStudyQuote: "We had 200+ printers across 20 locations. C9 implemented managed print telco & IT. Result: 40% reduction in print costs and 100% security compliance.",
    caseStudyAuthor: "CIO, Multi-Location Enterprise (20 locations)",
